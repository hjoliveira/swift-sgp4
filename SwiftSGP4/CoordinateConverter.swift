...
public class CoordinateConverter {
  ...
  public static func temeToECEF(
    position: Vector3D, velocity: Vector3D, date: Date
  ) -> (Vector3D, Vector3D) {
  ...
  public static let earthEccentricitySquared =
    2.0 * earthFlattening - earthFlattening * earthFlattening
}
